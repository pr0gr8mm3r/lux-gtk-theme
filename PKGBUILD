pkgname=materia-lux-gtk-theme
pkgver=20190315
pkgrel=1
pkgdesc="A Material Design theme for GNOME/GTK+ based desktop environments"
arch=('any')
url="https://github.com/pr0gr8mm3r/materia-theme"
license=('GPL')
...
source=(${pkgname}-${pkgver}.tar.gz::"https://github.com/pr0gr8mm3r/materia-theme/archive/v${pkgver}.tar.gz")
